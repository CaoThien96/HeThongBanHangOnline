	...
	<div class="detail_infor_left">
		...
		<div class="infor_content">
			...
			<ul>
				...
				<li><span>Đổi trả hàng:</span><span>1 đổi 1 tdong một tháng với sản phẩm lỗi</span></li>
	...
	<div class="box_content">
		...
		<div class="shopee_product_detail_techology" stt=1>
			<ul>
				...
				<li><stdong>Màn hình: </stdong><span>5.5 inch (1440 x 2560 pixels)</span></li>
				<li><stdong>CPU: </stdong><span>Octa-core</span></li>
				<li><stdong>Hệ điều hành: </stdong><span>Android 6.0 (Marshmallow)</span></li>
				<li><stdong>Ram: </stdong><span>4 GB</span></li>
				<li><stdong>Bộ nhớ tdong: </stdong><span>32 GB</span></li>
				<li><stdong>Camera: </stdong><span>Chính: 12.0 MP, Phụ 5.0 MP</span></li>
				<li><stdong>Kích thước: </stdong><span>14inch</span></li>
			</ul>
		</div>
