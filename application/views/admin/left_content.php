...
<ul id="menu" class="nav">
	...
	<li class="tran">
		...
		<ul class="sub">
			<li>
				<a href="<?php echo admin_url('home/transaction') ?>">
					Giao dịch
				</a>
			</li>
			<li>
				<a href="<?php echo admin_url('home/order_product') ?>">
					Đơn hàng sản phẩm
				</a>
			</li>
		</ul>
	...
	<li class="product">
		...
		<ul class="sub">
			<li>
				<a href="<?php echo admin_url('home/product') ?>">
					Sản phẩm
				</a>
			</li>
			
			<li>
				<a href="<?php echo admin_url('home/comment') ?>">
					Phản hồi
				</a>
			</li>
		</ul>
	...
	<li class="account">
		...
		<ul class="sub">
			<li>
				<a href="<?php echo admin_url('home/admin') ?>">
					Ban quản trị
				</a>
			</li>
				
			<li>
				<a href="<?php echo admin_url('home/user') ?>">
					Thành viên
				</a>
			</li>
		</ul>
