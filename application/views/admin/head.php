...
<link rel="stylesheet" type="text/css" href="<?php echo public_url('admin') ?>/crown/css/reset.css" />
...
<script type="text/javascript" src="<?php echo public_url('admin') ?>/js/jquery/jquery.min.js"></script>
<script type="text/javascript" src="<?php echo public_url('admin') ?>/js/jquery/jquery-ui.min.js"></script>
...
<script type="text/javascript" src="<?php echo public_url('admin') ?>/js/admin_product.js"></script>
<script type="text/javascript" src="<?php echo public_url('admin') ?>/js/admin_user.js"></script>
<script type="text/javascript" src="<?php echo public_url('admin') ?>/js/admin_order.js"></script>
<script type="text/javascript" src="<?php echo public_url('admin') ?>/js/admin_comment.js"></script>
<link rel="stylesheet" type="text/css" href="<?php echo public_url('css').'/admin_css/order.css' ?>" />


<script type="text/javascript" src="<?php echo public_url('admin') ?>/js/ckeditor/ckeditor.js"></script> 
<script type="text/javascript" src="<?php echo public_url('admin') ?>/js/jquery/chosen/chosen.jquery.min.js"></script>
<script type="text/javascript" src="<?php echo public_url('admin') ?>/js/jquery/scrollTo/jquery.scrollTo.js"></script>
<script type="text/javascript" src="<?php echo public_url('admin') ?>/js/jquery/number/jquery.number.min.js"></script>
<script type="text/javascript" src="<?php echo public_url('admin') ?>/js/jquery/formatCurrency/jquery.formatCurrency-1.4.0.min.js"></script>
<script type="text/javascript" src="<?php echo public_url('admin') ?>/js/jquery/zclip/jquery.zclip.js"></script>

<script type="text/javascript" src="<?php echo public_url('admin') ?>/js/jquery/colorbox/jquery.colorbox.js"></script>
<link rel="stylesheet" type="text/css" href="<?php echo public_url('admin') ?>/js/jquery/colorbox/colorbox.css" media="screen" />

<script type="text/javascript" src="<?php echo public_url('admin') ?>/js/custom_admin.js" type="text/javascript"></script>